...
const QuestionPage = () => {
  return (
    <div className="w-full h-[832px] bg-white overflow-hidden flex flex-col items-start justify-start gap-[217px_0px] tracking-[normal] text-left text-mini text-white font-inter lg:h-auto mq450:gap-[217px_0px] mq750:gap-[217px_0px]">
