const Question = () => {
  return (
    <div className="w-[1167px] flex-1 flex flex-col items-end justify-start pt-[3px] px-[45px] pb-[37px] box-border relative gap-[44px_0px] max-w-full text-left text-28xl text-black font-nunito-sans lg:pl-[22px] lg:pr-[22px] lg:box-border mq750:gap-[44px_0px]">
      <img
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 pr-[54px] pl-0">
        <h1 className="m-0 relative text-inherit font-semibold font-inherit z-[3] mq450:text-9xl mq1050:text-19xl text-8xl">
          Topic
        </h1>
      </div>
        ...
        <div className="self-stretch w-[931px] flex flex-col items-start justify-start gap-[28px_0px] max-w-full">
          ...
          <div className="self-stretch flex-1 flex flex-row items-start justify-start py-0 pr-px pl-1 box-border max-w-full">
            <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[16px_0px] max-w-full">
              ...
              <div className="self-stretch flex-1 relative z-[3] flex items-center justify-center">
                <img
                  className="self-stretch flex-1 w-[700px] overflow-hidden max-h-full z-[3] object-contain absolute left-[6px] top-[4px] w-full h-full [transform:scale(1.34)]"
                  alt=""
                  src="/group-325.svg"
                />
              </div>
